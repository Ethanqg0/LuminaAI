    ...
    return (
        <div className="w-full h-full mx-auto">
                <div className="flex flex-col items-center mt-[10vh]">
                    <h2 className="mb-5 text-gray-900 font-sans font-bold text-2xl">Sign Up</h2>
                    ...
                    <form onSubmit={handleSignupSubmit}>
                        <input onChange={handleInputChange} type="text" className="w-full px-6 py-3 mb-2 border border-slate-600 rounded-lg font-medium " placeholder="Email" value={formData.email} name="email"/>
                        <input onChange={handleInputChange} type="password" className="w-full px-6 py-3 mb-2 border border-slate-600 rounded-lg font-medium " placeholder="Password" value={formData.password} name="password"/>
                        <input onChange={handleInputChange} type="password" className="w-full px-6 py-3 mb-2 border border-slate-600 rounded-lg font-medium " placeholder="Confirm password" value={formData.confirmedPassword} name="confirmedPassword"/>
                    ...
                    <p className="text-center mt-3 text-[14px]">Already have an account? 
                        <a onClick={ navigateToLogin } className="text-gray-600"> Log In</a>
                    </p>
